...
ALTER TABLE populairste_producten DROP CONSTRAINT FKpopulairst726254;
...
DROP TABLE IF EXISTS populairste_producten CASCADE;
...
CREATE TABLE populairste_producten (productsID varchar(255) NOT NULL, PRIMARY KEY (productsID));
...
ALTER TABLE populairste_producten ADD CONSTRAINT FKpopulairst726254 FOREIGN KEY (productsID) REFERENCES products (ID);
